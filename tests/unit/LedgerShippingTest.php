...
use App\Services\Transfer\Ledgers\ShippingLedgerTransfer;
use Illuminate\Database\Eloquent\Collection;

class LedgerShippingTest extends TestCase
{
     ...
     * @return void
     */
    public function testLedgerShippingCreate()
    {
        ...
        $toWallet->save();
        $ledgerAmount = Transfers::typeOf('shipping')->sum('amount');
        $ledgerService = new ShippingLedger(new Ledger(), new TransfersFetcher(new Transfers()));
        ...
        $transferLedger = new ShippingLedgerTransfer(new TransferService(new Wallet(), new Transfers()));
