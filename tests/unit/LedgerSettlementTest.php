...
use App\Services\Ledger\SettlementLedger;
use App\Services\Transfer\Ledgers\SettlementLedgerTransfer;
use Illuminate\Database\Eloquent\Collection;

class LedgerSettlementTest extends TestCase
{
     ...
     * @return void
     */
    public function testLedgerSettlementCreate()
    {
        ...
        $toWallet->save();
        $ledgerAmount = Transfers::typeOf('production_cost')->sum('amount');
        $ledgerService = new SettlementLedger(new Ledger(), new TransfersFetcher(new Transfers()));
        ...
        $transferLedger = new SettlementLedgerTransfer(new TransferService(new Wallet(), new Transfers()));
