...
class LedgerCollectionTest extends TestCase
{
     ...
     * @return void
     */
    public function testLedgerCollectionCreate()
    {
        ...
        DB::transaction(function () {
            $ledgerAmount = Transfers::typeOf('collection')->sum('amount');
            $ledgerService = new CollectionLedger(new Ledger(), new TransfersFetcher(new Transfers()));
            ...
            $transferLedger = new CollectionLedgerTransfer(new TransferService(new Wallet(), new Transfers()));
